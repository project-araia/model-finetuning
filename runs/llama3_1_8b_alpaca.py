...
model, tokenizer = FastLanguageModel.from_pretrained(
    ...
    model_name= "/home/akash/.cache/huggingface/hub/models--unsloth--Meta-Llama-3.1-8B/snapshots/ebcab843b599f8c57e108d6199b7d7d4fd7fc5dd",
...
def tokenize_function(examples):
    texts = examples["text"]  # The text is the output of the formatting function
    # Tokenizing and ensuring the tensors are moved to CPU
    tokenized = tokenizer(texts, padding=True, truncation=True, max_length=512, return_tensors="pt")
    return {key: value.to('cpu') for key, value in tokenized.items()}  # Move tensors to CPU
