...
for grid_cell in grid_cells:
    output_data.append({
        "user": f'What is the projected annual max temperature at {grid_cell["grid_cell"]} by the end of the century?',
        "input": {
        ...
        "assistant": f'At grid {grid_cell["grid_cell"]}, the annual maximum temperature is projected to reach {grid_cell["rcp85"]["end_century"]}°F under RCP 8.5, {grid_cell["rcp45"]["end_century"]}°F under RCP 4.5 and  by the end of the century.' 
   })
